    ...
    <div className="min-h-full bg-gray-50/60">
      <div className="max-w-2xl mx-auto px-4 py-6 md:py-8 pb-28 md:pb-10 space-y-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div>
            <h1 className="text-[22px] font-black tracking-tight text-gray-900">集客ファネル</h1>
        ...
        {overallRate !== null && (
          <div className="flex items-center justify-between rounded-2xl bg-gray-900 px-5 py-4 text-white">
            <div>
              <p className="text-xs text-gray-400 mb-0.5">広告クリック → 来店 の総転換率</p>
              <p className="text-3xl font-black">{overallRate}%</p>
            </div>
            <div className="text-right">
              <p className="text-xs text-gray-400">{month}月の成果</p>
        ...
        {adClicks === 0 && lpViews === 0 && (
          <div className="rounded-2xl border border-dashed border-gray-200 bg-white py-12 text-center">
            ...
            <p className="text-sm font-semibold text-gray-400">この月のデータはまだありません</p>
            <p className="text-xs text-gray-300 mt-1">広告データが連携されると自動で表示されます</p>
          </div>
        )}
